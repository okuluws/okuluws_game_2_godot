...
class Modules:
	const Players = preload("modules/players/main_server.gd")
	var players: Players
	const Items = preload("modules/items/items_server.gd")
	var items: Items
	const Inventories = preload("modules/inventories/main_server.gd")
	var inventories: Inventories
	const Overworld = preload("modules/overworld/main_server.gd")
