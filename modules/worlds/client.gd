...
class Modules:
	const Players = preload("modules/players/main_client.gd")
	var players: Players
	const Items = preload("modules/items/items_client.gd")
	var items: Items
	const Overworld = preload("modules/overworld/main_client.gd")
